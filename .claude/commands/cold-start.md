...
2. `tez-docs/MEMORY.md` oku — kalici hafiza, teknik kararlar, ogrenilen pattern'ler
3. `tez-tasks/task-index.md` oku — dashboard + tum task durumlari
4. `tez-tasks/active/session-notes.md` oku — onceki session notlari
